...
export default function Slider({ onPriceChange }: { onPriceChange: Function }) {
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    <View style={styles.infocontainer}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <View style={styles.iconcontainer}>
                                <Icon type={Icons.Ionicons} name="pricetags-outline" size={20} color={'gray'} />
                            </View>
                            <View>
                    ...
                    <View style={{ width: Dimensions.get('screen').width - 40, marginLeft: 10 }}>
                        <RangeSlider
                            ...
                            onSliderTouchEnd={(low, high) => onPriceChange(low, high)}
